...
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    backlogListArray = ['do nothing', 'drink coffee'];
    progressListArray = ['Work on projects', 'Listen to music'];
    completeListArray = ['code', 'Getting stuff done'];
    onHoldListArray = ['walk the dog', 'take trash out'];
  }
}
...
function filterArray(array) {
  const filteredArray = array.filter(item => item !== null || undefined);
